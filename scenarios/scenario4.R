...
# improve all imd1 by 10% then reduce gap between 2/3 to 1 by 50% and then 4/5 to 3 by 50%
...
# improve all imd by 10%  then reduce gap between 2/3 to 1 by 50% and then 4/5 to 1 by 50%
