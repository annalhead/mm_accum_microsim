...
scenario <- "scenario2"
#universal policy with additional focus on the gap
# increase length of time in state for all imds by 10% and then reduce the gap between 4/5 and 3 by 50%
# NB if change scenario 1, then change this to match
...
#increase length of time in state for all imds by 10% and then reduce the gap between 4/5 and 1 by 20%
