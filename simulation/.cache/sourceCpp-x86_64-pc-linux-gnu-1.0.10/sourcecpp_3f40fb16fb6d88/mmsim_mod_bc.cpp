...
NumericMatrix parallel_random_matrix(const int n, const int m, const uint64_t seed, const int ncores);
RcppExport SEXP sourceCpp_1_parallel_random_matrix(SEXP nSEXP, SEXP mSEXP, SEXP seedSEXP, SEXP ncoresSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(parallel_random_matrix(n, m, seed, ncores));
    return rcpp_result_gen;
END_RCPP
}
// mmsim
List mmsim(const DataFrame& pop, const DataFrame& dfTransitionTimeQuantilesBySimulantType, const NumericMatrix& rank, const double& Mcalib_t12, const double& Mcalib_t34, const double& Mcalib_t56, const double& Mcalib_t7, const double& Fcalib_t12, const double& Fcalib_t34, const double& Fcalib_t56, const double& Fcalib_t7, const double& Mnudge_t5);
RcppExport SEXP sourceCpp_1_mmsim(SEXP popSEXP, SEXP dfTransitionTimeQuantilesBySimulantTypeSEXP, SEXP rankSEXP, SEXP Mcalib_t12SEXP, SEXP Mcalib_t34SEXP, SEXP Mcalib_t56SEXP, SEXP Mcalib_t7SEXP, SEXP Fcalib_t12SEXP, SEXP Fcalib_t34SEXP, SEXP Fcalib_t56SEXP, SEXP Fcalib_t7SEXP, SEXP Mnudge_t5SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const DataFrame& >::type pop(popSEXP);
    Rcpp::traits::input_parameter< const DataFrame& >::type dfTransitionTimeQuantilesBySimulantType(dfTransitionTimeQuantilesBySimulantTypeSEXP);
    Rcpp::traits::input_parameter< const NumericMatrix& >::type rank(rankSEXP);
    Rcpp::traits::input_parameter< const double& >::type Mcalib_t12(Mcalib_t12SEXP);
    Rcpp::traits::input_parameter< const double& >::type Mcalib_t34(Mcalib_t34SEXP);
    Rcpp::traits::input_parameter< const double& >::type Mcalib_t56(Mcalib_t56SEXP);
    Rcpp::traits::input_parameter< const double& >::type Mcalib_t7(Mcalib_t7SEXP);
    Rcpp::traits::input_parameter< const double& >::type Fcalib_t12(Fcalib_t12SEXP);
    Rcpp::traits::input_parameter< const double& >::type Fcalib_t34(Fcalib_t34SEXP);
    Rcpp::traits::input_parameter< const double& >::type Fcalib_t56(Fcalib_t56SEXP);
    Rcpp::traits::input_parameter< const double& >::type Fcalib_t7(Fcalib_t7SEXP);
    Rcpp::traits::input_parameter< const double& >::type Mnudge_t5(Mnudge_t5SEXP);
    rcpp_result_gen = Rcpp::wrap(mmsim(pop, dfTransitionTimeQuantilesBySimulantType, rank, Mcalib_t12, Mcalib_t34, Mcalib_t56, Mcalib_t7, Fcalib_t12, Fcalib_t34, Fcalib_t56, Fcalib_t7, Mnudge_t5));
    return rcpp_result_gen;
END_RCPP
}
